...
namespace TimerCounterLister
{
    ...
    */
    ...
    [CommandInfo("Pause Selected Timer Counter", "tcl.tcc.pause", "tcl.core")]
    class PauseTimerCounterCommand : ICommand
    {
        public override void Execute(object[] parameters, out object[] responses)
        {
            ...
            if (tc.IsTimerPaused)
            {
                ManagedMessageBox.ShowMessage(Properties.Resources.Message_SelectedTimerCounterAlreadyPaused);
                return;
            }
