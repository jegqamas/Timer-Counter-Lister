...
namespace TimerCounterLister
{
    public partial class FormEnterName : Form
    {
        ...
        public FormEnterName()
        {
            ...
            checkBox_show_password.Visible = false;
        }
        /// <summary>
        /// A dialog used to enter name
        /// </summary>
            ...
            bool AutoDisableButton, bool PasswordChars)
        {
            ...
            checkBox_show_password.Visible = PasswordChars;
        }

        bool AutoDisableButton = true;
        /// <summary>
        /// Raised when the user clicked the ok button, allows to cancel the form closing using the args
        /// </summary>
        ...
        {
            textBox1.UseSystemPasswordChar = !checkBox_show_password.Checked;
        }
    }
}
